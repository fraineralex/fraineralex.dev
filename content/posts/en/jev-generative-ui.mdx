...
The playground below sends its prompt to a server route that composes a Spec with live **jev** through Vercel AI Gateway. The API key stays on the server and never enters the browser bundle.
