...
<img
  className="jev-tall-media"
  src="/images/blog/posts/content/vercel-jev-adoption-chart.webp"
  alt="Vercel AI Gateway chart: Jev fastest adoption in first 24 hours"
/>
...
<img
  className="jev-tall-media"
  src="/images/blog/posts/content/vercel-jev-free-until-sep25.webp"
  alt="Vercel AI Gateway promo: Jev free until September 25"
/>
...
<video
  className="jev-tall-media rounded-xl border border-zinc-700 my-6"
  controls
  playsInline
  preload="metadata"
...
_Demo from [Chris Tate on X](https://x.com/ctatedev/status/2101022101750571357)._
