...
export default function Loading () {
  return (
    <div className='min-h-screen max-w-6xl md:max-w-5xl mx-auto px-4 md:px-8 text-zinc-300 animate-pulse'>
      <header>
        <div className={`fixed inset-x-0 top-0 z-50`}>
          <div className='container flex flex-row-reverse items-center justify-between p-6 mx-auto'>
            <div className='flex justify-between gap-8 pr-5'>
              <Eye
                className='h-5 w-5 text-gray-700 me-2'
            ...
            <div className='flex flex-row items-center sm:pl-5'>
              ...
              <div>
                <div className='w-34 h-4 bg-gray-200 rounded-full dark:bg-gray-700'/>
              </div>
            </div>
          </div>
        </div>
