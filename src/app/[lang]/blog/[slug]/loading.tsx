...
export default function Loading () {
  return (
    <div className='min-h-screen max-w-6xl md:max-w-5xl mx-auto px-4 md:px-8 text-slate-300 animate-pulse bg-slate-900'>
      <header>
        <div className={`fixed inset-x-0 top-0 z-50`}>
          <div className='container flex flex-row-reverse items-center justify-between p-6 mx-auto'>
            <div className='flex justify-between gap-8 pr-5'>
              <Eye
                className='h-5 w-5 text-slate-600 me-2'
            ...
            <div className='flex flex-row items-center sm:pl-5'>
              <svg
                className='text-slate-700 mr-1 sm:mr-2 h-6 w-6 sm:h-8 sm:w-8 shrink-0 overflow-hidden rounded-full'
                aria-hidden='true'
              ...
              <div>
                <div className='w-34 h-4 bg-slate-700 rounded-full'/>
              </div>
            </div>
          </div>
        </div>
